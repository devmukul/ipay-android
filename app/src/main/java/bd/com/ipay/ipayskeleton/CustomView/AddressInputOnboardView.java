...
public class AddressInputOnboardView extends FrameLayout implements HttpResponseListener {
    ...
    public AddressInputOnboardView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initView(context);
    }

    public AddressInputOnboardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public AddressInputOnboardView(Context context) {
        super(context);
        initView(context);
    }
    ...
    private void initView(Context context) {
        ...
        View v = inflate(context, R.layout.view_address_input_onboard, null);
