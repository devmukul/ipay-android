...
public class IdentificationDocumentsRequestBuilder {
    private String generatedUri;

    public IdentificationDocumentsRequestBuilder() {
        generateUri();
    }
    ...
    private void generateUri() {
        try {
            URI uri = new URIBuilder()
                    ...
                    .setPath(Constants.BASE_URL_GET_MM_PATH + "/" + Constants.URL_GET_DOCUMENTS)
                    .build();
