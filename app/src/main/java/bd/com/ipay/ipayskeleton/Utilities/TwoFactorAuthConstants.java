...
public class TwoFactorAuthConstants {
	...
	public static HashMap<String, String> getProgressDialogStringMap(Context context) {
		...
		mProgressDialogStringMap.put(Constants.COMMAND_SEND_MONEY, context.getString(R.string.sending_money));
		mProgressDialogStringMap.put(Constants.COMMAND_TOPUP_REQUEST, context.getString(R.string.dialog_requesting_top_up));
		mProgressDialogStringMap.put(Constants.COMMAND_ADD_MONEY_FROM_BANK, context.getString(R.string.progress_dialog_add_money_in_progress));
		mProgressDialogStringMap.put(Constants.COMMAND_ADD_MONEY_FROM_BANK_INSTANTLY, context.getString(R.string.progress_dialog_add_money_instantly_in_progress));
