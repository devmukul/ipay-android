...
public class IpayHereFragmentF extends ProgressFragment implements PlaceSelectionListener, HttpResponseListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{

    private static final String TAG = bd.com.ipay.ipayskeleton.HomeFragments.IpayHereFragment.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (!Utilities.isNecessaryPermissionExists(getContext(), Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION)) {
