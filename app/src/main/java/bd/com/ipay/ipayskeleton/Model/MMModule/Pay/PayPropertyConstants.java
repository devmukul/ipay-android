...
public class PayPropertyConstants {
    ...
    static {
        PAY_PROPERTY_NAME_TO_ICON_MAP.put(TOP_UP, R.drawable.ic_photoid);
        PAY_PROPERTY_NAME_TO_ICON_MAP.put(MAKE_PAYMENT, R.drawable.ic_photoid);
        PAY_PROPERTY_NAME_TO_ICON_MAP.put(EDUCATION, R.drawable.ic_parent);
        PAY_PROPERTY_NAME_TO_ICON_MAP.put(CREATE_INVOICE, R.drawable.ic_parent);
    }
}
