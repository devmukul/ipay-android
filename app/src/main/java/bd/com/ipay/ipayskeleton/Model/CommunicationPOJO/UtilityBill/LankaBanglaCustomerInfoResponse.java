...
public class LankaBanglaCustomerInfoResponse {
	...
	public LankaBanglaCustomerInfoResponse(String message, String name, String cardNumber, String creditLimit, String creditBalance, String minimumPay) {
