...
public class LankaBanglaDpsNumberInputFragment extends IPayAbstractCardNumberInputFragment implements HttpResponseListener {
	...
	private void showLankaBanglaUserInfo(final LankaBanglaCustomerInfoResponse lankaBanglaCustomerInfoResponse) {
		...
		billDetailsDialog.setPayBillButtonAction(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				bundle.putInt(LankaBanglaDpsAmountInputFragment.TOTAL_OUTSTANDING_AMOUNT_KEY, Integer.parseInt(lankaBanglaCustomerInfoResponse.getCreditBalance()));
				bundle.putInt(LankaBanglaDpsAmountInputFragment.MINIMUM_PAY_AMOUNT_KEY, Integer.parseInt(lankaBanglaCustomerInfoResponse.getMinimumPay()));
				bundle.putString(LankaBanglaDpsAmountInputFragment.CARD_NUMBER_KEY, lankaBanglaCustomerInfoResponse.getCardNumber());
