                ...
                try {
                    ...
                    if (result.getStatus() == Constants.HTTP_RESPONSE_STATUS_OK) {
                        if (getActivity() != null) {
                            ...
                            Utilities.sendSuccessEventTracker(mTracker, getString(R.string.screen_name_parent_info_edit), ProfileInfoCacheManager.getAccountId(), 100);
                        }
                    } else {
                        if (getActivity() != null)
                        ...
                        //Google Analytic event
                        Utilities.sendFailedEventTracker(mTracker, getString(R.string.screen_name_parent_info_edit), ProfileInfoCacheManager.getAccountId(), mSetParentInfoResponse.getMessage(), 0);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    if (getActivity() != null)
