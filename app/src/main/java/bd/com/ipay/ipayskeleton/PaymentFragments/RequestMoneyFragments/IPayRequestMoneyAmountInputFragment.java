...
public class IPayRequestMoneyAmountInputFragment extends IPayAbstractAmountFragment {
	...
	protected void performContinueAction() {
		if (getActivity() instanceof IPayTransactionActionActivity) {
			...
			((IPayTransactionActionActivity) getActivity()).switchFragment(new IPayRequestMoneyConfirmationFragment(), bundle, 2, true);
		}
	}

	@Override
	protected int getServiceId() {
		return ServiceIdConstants.REQUEST_MONEY;
	}
