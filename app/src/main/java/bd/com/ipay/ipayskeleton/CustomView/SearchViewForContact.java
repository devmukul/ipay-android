...
public class SearchViewForContact extends FrameLayout {
    ...
    public SearchViewForContact(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initView(context, attrs);
    }

    public SearchViewForContact(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public SearchViewForContact(Context context) {
        super(context);
