        ...
        mContinueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isValidInputs()) {
                    ...
                    bundle.putInt(Constants.OPERATOR_CODE, operatorCode);final BigDecimal amount = new BigDecimal(mAmountTextView.getText().toString().replaceAll("[^\\d.]", ""));
