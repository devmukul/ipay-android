...
public class IPayTransactionAmountInputFragment extends Fragment implements View.OnClickListener {
	...
	public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
		...
		LinearLayout mTopUpDefaultAmountLayout = view.findViewById(R.id.default_top_up_amount);
		mTakaFiftyTextView = view.findViewById(R.id.text_view_taka_fifty);
		mTakaHundredTextView = view.findViewById(R.id.text_view_taka_hundred);
		mTakaTwoHundredTextView = view.findViewById(R.id.text_view_taka_two_hundred);
		mTakaFiveHundredTextView = view.findViewById(R.id.text_view_taka_five_hundred);
