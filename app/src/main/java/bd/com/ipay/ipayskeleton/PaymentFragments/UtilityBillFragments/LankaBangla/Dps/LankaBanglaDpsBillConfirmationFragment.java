							...
							case Constants.HTTP_RESPONSE_STATUS_OK:
								...
								new Handler().postDelayed(new Runnable() {
									...
									public void run() {
										...
										bundle.putString(LankaBanglaDpsAmountInputFragment.CARD_NUMBER_KEY, cardNumber);
										bundle.putSerializable(LankaBanglaDpsBillConfirmationFragment.BILL_AMOUNT_KEY, billAmount);
