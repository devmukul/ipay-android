    ...
    public static HttpRequestPostAsyncTask getPostAsyncTask(String command, String json,
        ...
        switch (command) {
            ...
            case Constants.COMMAND_SEND_MONEY:
                ...
                mHttpPostAsyncTask = new HttpRequestPostAsyncTask(Constants.COMMAND_SEND_MONEY, uri, json, context);
            ...
            case Constants.COMMAND_TOPUP_REQUEST:
                ...
                mHttpPostAsyncTask = new HttpRequestPostAsyncTask(Constants.COMMAND_TOPUP_REQUEST, uri, json, context);
                return mHttpPostAsyncTask;
            ...
            case Constants.COMMAND_ADD_MONEY:
                ...
                mHttpPostAsyncTask = new HttpRequestPostAsyncTask(Constants.COMMAND_ADD_MONEY, uri, json, context);
                return mHttpPostAsyncTask;
            ...
            case Constants.COMMAND_WITHDRAW_MONEY:
                ...
                mHttpPostAsyncTask = new HttpRequestPostAsyncTask(Constants.COMMAND_WITHDRAW_MONEY, uri, json, context);
                return mHttpPostAsyncTask;
            ...
            case Constants.COMMAND_PAYMENT:
                ...
                mHttpPostAsyncTask = new HttpRequestPostAsyncTask(Constants.COMMAND_PAYMENT, uri, json, context);
                return mHttpPostAsyncTask;
            ...
            case Constants.COMMAND_SEND_PAYMENT_REQUEST:
                ...
                mHttpPostAsyncTask = new HttpRequestPostAsyncTask(Constants.COMMAND_SEND_PAYMENT_REQUEST, uri, json, context);
                return mHttpPostAsyncTask;
