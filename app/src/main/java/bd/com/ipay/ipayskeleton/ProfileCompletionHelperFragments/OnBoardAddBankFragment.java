...
public class OnBoardAddBankFragment extends BaseFragment implements HttpResponseListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_onboard_add_bank, container, false);
