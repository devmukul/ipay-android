...
public class GetTrustedDevicesRequestBuilder {
    private String generatedUri;

    public GetTrustedDevicesRequestBuilder() {
        generateUri();
    }
    ...
    private void generateUri() {
        try {
            URI uri = new URIBuilder()
                    ...
                    .setPath(Constants.BASE_URL_GET_MM_PATH + "/" + Constants.URL_GET_TRUSTED_DEVICES)
                    .build();
