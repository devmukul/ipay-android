...
public class GetIntroducerListRequestBuilder {
    private String generatedUri;

    public GetIntroducerListRequestBuilder() {
        generateUri();
    }
    ...
    private void generateUri() {
        try {
            URI uri = new URIBuilder()
                    ...
                    .setPath(Constants.BASE_URL_GET_MM_PATH + "/" + Constants.URL_GET_INTRODUCER_LIST)
                    .build();
