...
public class IPayProgressFragment extends BaseFragment {
	...
	public final View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		final View contentView = onCreateContentView(inflater, rootView, savedInstanceState);
		contentViewHolder.addView(contentView);
		return rootView;
	}
